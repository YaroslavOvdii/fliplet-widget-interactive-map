...
Vue.directive('sortable', {
  inserted: function inserted(el, binding) {
    if (sortablejs_Sortable_js__WEBPACK_IMPORTED_MODULE_2__) {
      new sortablejs_Sortable_js__WEBPACK_IMPORTED_MODULE_2__(el, binding.value || {});
    }
  }
});
  ...
  methods: {
    ...
    onPanelSettingChanged: function onPanelSettingChanged(panelData) {
      ...
      this.maps.forEach(function (panel, index) {
        ...
        panel.error = '';
        panelData.error = '';
        Vue.set(_this3.maps, index, panel); // If exists update panel with new data

        if (panelData.id === panel.id) {
          // To overcome the array change caveat
          // https://vuejs.org/v2/guide/list.html#Caveats
          Vue.set(_this3.maps, index, panelData);
        }
    ...
    openAddMarkers: function openAddMarkers() {
      this.hasError = false;
      this.hasErrorOnSave = false; // Error checking
    ...
    prepareToSaveData: function prepareToSaveData(stopComplete, imageSaved) {
      ...
      promise.then(function () {
        _this4.saveData(stopComplete, imageSaved);
      });
    },
...
/***/ 2:
/*!************************************!*\
  !*** multi ./js/libs/interface.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\hugoc\Documents\GitHub\Fliplet\fliplet-widget-interactive-map\js\libs\interface.js */"./js/libs/interface.js");
