 ...
 **/
var _gsScope =  true && module.exports && typeof global !== "undefined" ? global : undefined || window; //helps ensure compatibility with AMD/RequireJS and CommonJS/Node
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    */
    ...
    _registerComplexSpecialProp("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
      parser: function parser(t, e, parsingProp, cssp, pt, plugin, vars) {
        ...
        if (orig && typeof orig === "string" && _transformProp) {
        ...
        } else if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(v) === "object") {
          ...
          if (dr != null) {
            if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(dr) === "object") {
              for (copy in dr) {
                v[copy] = dr[copy];
              }
            } else {
  ...
  (function () {
    ...
    p._onInitAllProps = function () {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(rp) === "object" && !rp.push) {
        for (p in rp) {
...
(function (window, moduleName) {
  ...
  var _namespace = function _namespace(ns) {
    ...
    var toString = Object.prototype.toString,
        array = toString.call([]);
    return function (obj) {
      return obj != null && (obj instanceof Array || _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(obj) === "object" && !!obj.push && toString.call(obj) === array);
    };
  }(),
      a,
      i,
  ...
  _addPropTween = function _addPropTween(target, prop, start, end, overwriteProp, mod, funcParam, stringFilter, index) {
    ...
    var type = _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(target[prop]),
  ...
  p._kill = function (vars, target, overwritingTween) {
    ...
    if ((_isArray(target) || _isSelector(target)) && typeof target[0] !== "number") {
      ...
      if (propLookup) {
        ...
        record = vars !== overwrittenProps && overwrittenProps !== "all" && vars !== propLookup && (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(vars) !== "object" || !vars._tempKill); //_tempKill is a super-secret way to delete a particular tweening property but NOT have it remembered as an official overwritten property (like in BezierPlugin)
  ...
  TweenLite.killTweensOf = TweenLite.killDelayedCallsTo = function (target, onlyActive, vars) {
    if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(onlyActive) === "object") {
...
})( true && module.exports && typeof global !== "undefined" ? global : undefined || window, "TweenMax");
...
/***/ 3:
/*!**********************************!*\
  !*** multi ./vendor/TweenMax.js ***!
  \**********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/hcarneiro/Repos/Fliplet/fliplet-widget-interactive-floorplan/vendor/TweenMax.js */"./vendor/TweenMax.js");
